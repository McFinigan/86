...
class Expando(Base):
    ...
    def Is(self):
        elems = self.driver.find_elements(By.CSS_SELECTOR, ".srp_filter_clickable_area.model")
        return len(elems) > 0
    ...
    def run(self):
        ...
        # Find model dropdown
        elems = driver.find_elements(By.CSS_SELECTOR, ".srp_filter_clickable_area.model")
        ...
        elems = driver.find_elements(By.CSS_SELECTOR, ".srp_filter_option")
        ...
        # Find all car links
        elems = driver.find_elements(By.CSS_SELECTOR, "[aria-label=\"More Details\"]")
